...
#    Updated: 2022/07/20 14:56:28 by mcouppe          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME		=	minishell

SRCS_FILES	=	main.c utils_parsing.c sdf.c ft_free.c cd.c shlvl_decr.c \
			...
			export_pars_tools.c exec_cupboard.c export_errors.c shlvl_incr.c
